...
namespace RecipeManager
{
    public class WorkParams : ICloneable
    {
        ...
        public float _LEDInspectionDivergenceVMinAngle { get; set; } = -4F;
        public float _LEDInspectionDivergenceVMaxAngle { get; set; } = 4F;
        ...
        public object Clone()
        {
            ...
            temp._LEDInspectionDivergenceHMinAngle = this._LEDInspectionDivergenceHMinAngle;
            temp._LEDInspectionDivergenceHMaxAngle = this._LEDInspectionDivergenceHMaxAngle;
            temp._LEDInspectionDivergenceVMinAngle = this._LEDInspectionDivergenceVMinAngle;
            temp._LEDInspectionDivergenceVMaxAngle = this._LEDInspectionDivergenceVMaxAngle;
